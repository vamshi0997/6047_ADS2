...
/**
 *  The {@code SuffixArrayNew} class represents a suffix array of a string of
 *  length <em>n</em>.
...
public class SuffixArrayNew {
     ...
     */
    public SuffixArrayNew(String text) {
        int n = text.length();
    ...
    // /**
    //  * Unit tests the {@code SuffixArrayNew} data type.
    //  *
    //  * @param args the command-line arguments
    //  */
    // public static void main(String[] args) {
    //     String s = StdIn.readAll().replaceAll("\\s+", " ").trim();
    //     SuffixArrayNew suffix = new SuffixArrayNew(s);
